...
def test_basic_orchestrator():
    ...
    try:
        ...
        if result_state.get("error_message"):
            ...
            print(f"✅ Response generated: {len(result_state.get('agent_response', ''))} characters")
        ...
        result_state = financial_orchestrator.process_user_request(test_input, create_initial_state())
