...
class DisplayFormatter:
    ...
    def format_statement_display(self, statement_data: Dict[str, Any], statement_name: str) -> str:
        """
    ...
    def format_comparison_display(self, comparison_data: Dict[str, Any]) -> str:
        ...
        try:
            if not comparison_data or not comparison_data.get('success'):
                return f"Error: {comparison_data.get('error', 'Unknown comparison error')}"
    ...
    def format_recommendations_display(self, recommendations_data: Dict[str, Any]) -> str:
        """
