...
class FinancialDataService:
    ...
    def get_financial_statements(self, ticker: str) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                self.logger.warning(
                    f"Could not fetch income statement for {ticker}: {e}"
                )
    ...
    def get_peer_comparison_data(
        self, main_ticker: str, peer_tickers: list
    ) -> Dict[str, Any]:
        """
        ...
        for ticker in all_tickers:
            try:
                ...
                if result["success"]:
                    ...
                    self.logger.warning(
                        f"  Could not fetch data for {ticker}: {result['error']}"
                    )
    ...
    def suggest_peers_from_recommendations(
        self, ticker: str, max_peers: int = 4
    ) -> list:
        """
