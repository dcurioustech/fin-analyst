...
class InputValidator:
    ...
    def validate_ticker_list(
        self, tickers: List[str], max_count: int = 10
    ) -> Dict[str, Any]:
        """
        ...
        if len(valid_tickers) > max_count:
            ...
            self.logger.warning(
                f"Ticker count exceeded limit. Keeping first {max_count} tickers."
            )
    ...
    def validate_menu_input(
        self, choice: str, valid_range: tuple = (1, 9)
    ) -> Dict[str, Any]:
        """
    ...
    def validate_numeric_input(
        self, input_str: str, min_val: float = None, max_val: float = None
    ) -> Dict[str, Any]:
        """
        ...
        if not input_str or not input_str.strip():
            return {"valid": False, "error": "No input provided", "value": None}
    ...
    def validate_yes_no_input(self, input_str: str) -> Dict[str, Any]:
        ...
        if normalized in yes_values:
            ...
            return {"valid": False, "error": "Please enter yes/no (y/n)", "value": None}
