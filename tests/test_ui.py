...
class TestDisplayFormatter(unittest.TestCase):
    ...
    def test_format_company_profile_error(self):
        ...
        profile_data = {"success": False, "error": "Failed to analyze company profile"}
    ...
    def test_format_metrics_display_success(self):
        ...
        metrics_data = {
            ...
            "data": {
                ...
                "profitability": {"profit_margins": 0.253, "return_on_equity": 1.479},
                "stock_price": {"current_price": 150.25, "beta": 1.286},
                "dividend": {"dividend_yield": 0.0044, "payout_ratio": 0.1534},
            },
        }
        ...
        statement_data = {
            ...
            "data": {
                "formatted_data": pd.DataFrame(
                    {"2023": [100000, 80000, 20000], "2022": [90000, 70000, 20000]},
                    index=["Revenue", "Expenses", "Net Income"],
                ),
                "key_metrics": {"revenue_growth": 0.111, "net_margin": 0.20},
            },
        }

        result = self.formatter.format_statement_display(
            statement_data, "Income Statement"
        )
