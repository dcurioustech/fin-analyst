...
@tool
def analyze_company_profile(ticker: str, company_data: Dict[str, Any] = None) -> Dict[str, Any]:
    """
...
@tool
def analyze_financial_metrics(ticker: str, company_data: Dict[str, Any] = None) -> Dict[str, Any]:
    """
...
@tool
def analyze_financial_statements(ticker: str, statement_type: str, statements_data: Dict[str, Any] = None) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        if statement_type == 'income_statement':
            analysis_result = statement_analyzer.process_income_statement(statement_data)
        ...
        return {"success": False, "error": str(e), "tool": "analyze_financial_statements"}


@tool
def compare_companies(main_ticker: str, peer_tickers: List[str], comparison_data: Dict[str, Any] = None) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        if comparison_data is None:
            comparison_data_result = data_service.get_peer_comparison_data(main_ticker, peer_tickers)
...
def get_analyst_recommendations(ticker: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"success": False, "error": str(e), "tool": "get_analyst_recommendations"}


@tool
def analyze_income_statement(ticker: str, statements_data: Dict[str, Any] = None) -> Dict[str, Any]:
    """
...
@tool
def analyze_balance_sheet(ticker: str, statements_data: Dict[str, Any] = None) -> Dict[str, Any]:
    """
...
@tool
def analyze_cash_flow(ticker: str, statements_data: Dict[str, Any] = None) -> Dict[str, Any]:
    """
...
def get_financial_statements_data(ticker: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"success": False, "error": str(e), "tool": "get_financial_statements_data"}


@tool
def get_peer_comparison_data(main_ticker: str, peer_tickers: List[str]) -> Dict[str, Any]:
    """
