...
class FinancialAnalysisOrchestrator:
    ...
    def _build_graph(self) -> StateGraph:
        ...
        workflow.add_node("response_generation_routing", response_generation_routing_node)
    ...
    def process_user_request(self, user_input: str, state: FinancialOrchestratorState = None) -> FinancialOrchestratorState:
        """
