...
def update_state_with_user_input(state: FinancialOrchestratorState, user_input: str) -> FinancialOrchestratorState:
...
def update_state_with_agent_response(state: FinancialOrchestratorState, response: str) -> FinancialOrchestratorState:
...
def update_interpretation(state: FinancialOrchestratorState, interpretation: Dict[str, Any]) -> FinancialOrchestratorState:
...
def update_analysis_plan(state: FinancialOrchestratorState, plan: Dict[str, Any]) -> FinancialOrchestratorState:
...
def store_financial_data(state: FinancialOrchestratorState, ticker: str, data: Dict[str, Any]) -> FinancialOrchestratorState:
    """Store financial data in the state."""
    state["financial_data"][ticker] = data
    return state


def store_analysis_results(state: FinancialOrchestratorState, results: Dict[str, Any]) -> FinancialOrchestratorState:
...
def update_response_context(state: FinancialOrchestratorState, context: Dict[str, Any]) -> FinancialOrchestratorState:
    """Update state with response generation context."""
    state["response_context"] = context
    return state


def add_company_to_context(state: FinancialOrchestratorState, ticker: str) -> FinancialOrchestratorState:
...
def set_workflow_step(state: FinancialOrchestratorState, step: str) -> FinancialOrchestratorState:
    """Set the current workflow step."""
    state["workflow_step"] = step
    return state


def set_error(state: FinancialOrchestratorState, error_message: str) -> FinancialOrchestratorState:
